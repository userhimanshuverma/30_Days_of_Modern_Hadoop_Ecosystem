#!/bin/bash
# Day 16: Apache Spark Bootstrap script
# Location: Day-16-Spark-Core-Architecture/docker/bootstrap.sh
...
# Ensure configs from volume mounts are loaded
...
case "$ROLE" in
  ...
  spark-master)
    ...
    # Copy spark-defaults and spark-env from configs volume mount
